...
static refalrts::FnResult GenPattern(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      return refalrts::cSuccess;
#endif
    } while ( refalrts::open_evar_advance( ePattern_B_b_1, ePattern_B_e_1, bb_0, be_0 ) );
  } while ( 0 );
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        return refalrts::cSuccess;
#endif
      } while ( refalrts::open_evar_advance( ePattern_M_b_1, ePattern_M_e_1, bb_6, be_6 ) );
    } while ( refalrts::open_evar_advance( ePattern_B_b_1, ePattern_B_e_1, bb_0, be_0 ) );
  } while ( 0 );
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        return refalrts::cSuccess;
#endif
      } while ( refalrts::open_evar_advance( ePattern_M_b_1, ePattern_M_e_1, bb_7, be_7 ) );
    } while ( refalrts::open_evar_advance( ePattern_B_b_1, ePattern_B_e_1, bb_0, be_0 ) );
  } while ( 0 );
...
static refalrts::FnResult lambda_DoSaveBrackets_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::use( eCommandsBeforeEMatch_b_1 );
    static refalrts::Iter eCommandsBeforeEMatch_e_1;
    refalrts::use( eCommandsBeforeEMatch_e_1 );
    static refalrts::Iter eCommandsBeforeEMatch_b_2;
    refalrts::use( eCommandsBeforeEMatch_b_2 );
    static refalrts::Iter eCommandsBeforeEMatch_e_2;
    refalrts::use( eCommandsBeforeEMatch_e_2 );
    // s.LastBracket (~1 e.Commands_E )~1 e.CommandsBeforeEMatch
    if( ! refalrts::svar_left( sLastBracket_1, bb_0, be_0 ) )
      break;
    refalrts::Iter bb_1 = 0;
    refalrts::Iter be_1 = 0;
    ...
    const static refalrts::ResultAction raa[] = {
      ...
      {refalrts::icSpliceEVar, & eCommandsBeforeEMatch_b_1, & eCommandsBeforeEMatch_e_1},
      {refalrts::icBracket, 0, 0, refalrts::ibCloseCall},
      {refalrts::icBracket, 0, 0, refalrts::ibCloseBracket},
      {refalrts::icBracket, 0, 0, refalrts::ibOpenBracket},
      {refalrts::icCopyEVar, & eCommandsBeforeEMatch_b_1, & eCommandsBeforeEMatch_e_1},
      {refalrts::icBracket, 0, 0, refalrts::ibCloseBracket},
...
static refalrts::FnResult GenResult(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      return refalrts::cSuccess;
#endif
    } while ( refalrts::open_evar_advance( eCommands_B_b_1, eCommands_B_e_1, bb_2, be_2 ) );
  } while ( 0 );
...
static refalrts::FnResult MakeInterpCommands(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      return refalrts::cSuccess;
#endif
    } while ( refalrts::open_evar_advance( eCopiedVars_B_b_1, eCopiedVars_B_e_1, bb_0, be_0 ) );
  } while ( 0 );
...
static refalrts::FnResult GenerateResult_OpenELoops(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    static refalrts::Iter eIndex_e_2;
    refalrts::use( eIndex_e_2 );
    // e.Commands_B (~1 & CmdOpenedE & AlgLeft s.BracketNum 'e e.Index )~1 e.Commands_E
    eCommands_B_b_1 = 0;
    eCommands_B_e_1 = 0;
    do {
