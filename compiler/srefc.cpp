...
static refalrts::FnResult Main(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [ProgName] Depth[1] Usings[1]
    enum { __eConfig_1_1 = 8 };
    //for removing
    
    //debug ::varInfo:: Mode[e] Index [Config] Depth[1] Usings[1]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
...
static refalrts::FnResult FindFiles_Compilers(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[t] Index [Compilers] Depth[1] Usings[1]
...
static refalrts::FnResult Compile_And_Link(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [Files_E] Depth[1] Usings[1]
    ...
    //debug ::varInfo:: Mode[e] Index [Files_B] Depth[1] Usings[1]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
...
static refalrts::FnResult GetFileName(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [Output] Depth[1] Usings[2]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
...
static refalrts::FnResult DoGetFileName(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[s] Index [Last] Depth[1] Usings[1]
...
static refalrts::FnResult DoLower(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[s] Index [Lower] Depth[1] Usings[1]
    enum { __sUpper_1_1 = 3 };
    
    //debug ::varInfo:: Mode[s] Index [Upper] Depth[1] Usings[1]
    enum { __sUpper_1_2 = 4 };
    
    //debug ::varInfo:: Mode[s] Index [Upper] Depth[1] Usings[2]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
...
static refalrts::FnResult ScanCollisions(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [Output1] Depth[1] Usings[1]
    enum { __eOutput2_1_1 = 18 };
    //for removing
    
    //debug ::varInfo:: Mode[e] Index [Output2] Depth[1] Usings[1]
    ...
    //debug ::varInfo:: Mode[e] Index [Files_M] Depth[1] Usings[1]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
  ...
  do {
    ...
    //debug ::varInfo:: Mode[t] Index [Location] Depth[1] Usings[1]
    ...
    //debug ::varInfo:: Mode[e] Index [FileName] Depth[1] Usings[3]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
  ...
  do {
    ...
    //debug ::varInfo:: Mode[t] Index [Location1] Depth[1] Usings[1]
    enum { __eFileName_1_1 = 14 };
    //for removing
    ...
    //debug ::varInfo:: Mode[t] Index [Location2] Depth[1] Usings[1]
...
static refalrts::FnResult Renumerate(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[s] Index [NextNumber] Depth[1] Usings[1]
    ...
    //debug ::varInfo:: Mode[s] Index [NextNumber] Depth[1] Usings[2]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
  ...
  do {
    ...
    //debug ::varInfo:: Mode[t] Index [NextFile] Depth[1] Usings[1]
...
static refalrts::FnResult CompileEachFile(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [Source] Depth[1] Usings[2]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
...
static refalrts::FnResult FileNum(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [File] Depth[1] Usings[1]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
...
static refalrts::FnResult Link(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [Outputs_B] Depth[1] Usings[1]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
  ...
  do {
    ...
    //debug ::varInfo:: Mode[e] Index [Command] Depth[1] Usings[1]
    enum { __eOutputs_1_1 = 6 };
    //for removing
    
    //debug ::varInfo:: Mode[e] Index [Outputs] Depth[1] Usings[1]
    context[0] = arg_begin;
    context[1] = arg_end;
    refalrts::move_left( context[0], context[1] );
    refalrts::move_left( context[0], context[1] );
