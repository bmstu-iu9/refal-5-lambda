...
enum iCmd { /*NumberFromOpcode:Cmd+ic;Alg+Left,Alg+Right,Alg+Term,Allocate,Reinit,Update*/
  icThisIsGeneratedFunction = 0,
  icLoadConstants = 1,
  icIssueMemory = 2,
  ...
  icBracketRight = 34,
  icBracketTerm = 35,
  icBracketSaveLeft = 36,
  icBracketSaveRight = 37,
  icADTLeft = 38,
  icADTRight = 39,
  icADTTerm = 40,
  icADTSaveLeft = 41,
  ...
  ictRepeatRight = 60,
  ictRepeatTerm = 61,
  ictRepeatSaveLeft = 62,
  ictRepeatSaveRight = 63,
  icEPrepare = 64,
  icEStart = 65,
  icSave = 66,
  icResetAllocator = 67,
  ...
  icCopySTVar = 72,
  icReinitSVar = 73,
  /*+WORDS:El+Char,El+Func,El+Int,El+HugeInt,El+Ident,El+Bracket,El+String*/
  icAllocateChar = 74,
  icAllocateFunc = 75,
  icAllocateInt = 76,
  icAllocateHugeInt = 77,
  icAllocateIdent = 78,
