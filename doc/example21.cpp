...
static refalrts::FnResult lambda_Go_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // (~1 e.FileName )~1 s.Counter e.Lines
...
static refalrts::FnResult lambda_Go_2(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::alloc_name( n2, & refalrts::create_closure, "refalrts::create_closure" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n3 = 0;
    if( ! refalrts::alloc_name( n3, & lambda_Go_0, "lambda_Go_0" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n4 = 0;
    ...
    if( ! refalrts::alloc_open_call( n7 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n8 = 0;
    if( ! refalrts::alloc_name( n8, & MapReduce, "MapReduce" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n9 = 0;
    ...
    if( ! refalrts::alloc_name( n10, & refalrts::create_closure, "refalrts::create_closure" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n11 = 0;
    if( ! refalrts::alloc_name( n11, & lambda_Go_1, "lambda_Go_1" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n12 = 0;
    ...
    if( ! refalrts::alloc_open_call( n16 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n17 = 0;
    if( ! refalrts::alloc_name( n17, & LoadFile, "LoadFile" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n18 = 0;
...
static refalrts::FnResult lambda_Go_3(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  refalrts::this_is_generated_function();
  do {
    refalrts::Iter bb_0 = arg_begin;
    refalrts::Iter be_0 = arg_end;
...
refalrts::FnResult Go(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    const static refalrts::ResultAction raa[] = {
      ...
      {refalrts::icBracket, 0, 0, refalrts::ibOpenCall},
      {refalrts::icFunc, (void*) & lambda_Go_3, (void*) "lambda_Go_3"},
      {refalrts::icBracket, 0, 0, refalrts::ibOpenCall},
    ...
    if( ! refalrts::alloc_name( n1, & Map, "Map" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n2 = 0;
    if( ! refalrts::alloc_name( n2, & lambda_Go_2, "lambda_Go_2" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n3 = 0;
    if( ! refalrts::alloc_open_call( n3 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n4 = 0;
    if( ! refalrts::alloc_name( n4, & lambda_Go_3, "lambda_Go_3" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n5 = 0;
